...
if Selfsupervised == True:
    ...
    loss_fn_selfsupervised = loss_functions.initialize_intersection_HJI_selfsupervised(selfsupervised_dataset, Weight, Theta)

    path = 'experiment_HJI_' + opt.model + '_selfsupervised_' + str(policy[N_choice]) + '/'
