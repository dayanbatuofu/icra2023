...
if __name__ == '__main__':
    ...
    # ckpt_path = './model/gelu/model_selfsupervised_' + str(policy[N_choice]) + '_gelu.pth'
    activation = 'gelu'
    ...
    if save_data:
        ...
        # save_path = 'closed_loop/gelu/closedloop_traj_selfsupervised_initial_' + str(policy[N_choice]) + '_gelu.mat'
        ...
        # save_path = 'closed_loop/gelu/closedloop_traj_selfsupervised_expanded_' + str(policy[N_choice]) + '_gelu.mat'
