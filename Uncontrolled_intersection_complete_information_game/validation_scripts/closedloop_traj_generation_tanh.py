...
if __name__ == '__main__':
    ...
    if save_data:
        # save_path = 'closed_loop/tanh/closedloop_traj_hybrid_initial_' + str(policy[N_choice]) + '_tanh.mat'
        # save_path = 'closed_loop/tanh/closedloop_traj_supervised_initial_' + str(policy[N_choice]) + '_tanh.mat'
        # save_path = 'closed_loop/tanh/closedloop_traj_selfsupervised_initial_' + str(policy[N_choice]) + '_tanh.mat'
        # save_path = 'closed_loop/tanh/closedloop_traj_valuehardening_initial_' + str(policy[N_choice]) + '_tanh.mat'
        # save_path = 'closed_loop/tanh/closedloop_traj_hybrid_expanded_' + str(policy[N_choice]) + '_tanh.mat'
        # save_path = 'closed_loop/tanh/closedloop_traj_supervised_expanded_' + str(policy[N_choice]) + '_tanh.mat'
        # save_path = 'closed_loop/tanh/closedloop_traj_selfsupervised_expanded_' + str(policy[N_choice]) + '_tanh.mat'
        save_path = 'closed_loop/tanh/closedloop_traj_valuehardening_expanded_' + str(policy[N_choice]) + '_tanh.mat'
