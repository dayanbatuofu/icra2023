...
if __name__ == '__main__':
    ...
    ckpt_path = './model/sine/model_hybrid_' + str(policy[N_choice]) + '_sine.pth'
    # ckpt_path = './model/sine/model_supervised_' + str(policy[N_choice]) + '_sine.pth'
    # ckpt_path = './model/sine/model_selfsupervised_' + str(policy[N_choice]) + '_sine.pth'
    activation = 'sine'
    ...
    if save_data:
        save_path = 'closed_loop/sine/closedloop_traj_hybrid_initial_' + str(policy[N_choice]) + '_sine.mat'
        # save_path = 'closed_loop/sine/closedloop_traj_supervised_initial_' + str(policy[N_choice]) + '_sine.mat'
        # save_path = 'closed_loop/sine/closedloop_traj_selfsupervised_initial_' + str(policy[N_choice]) + '_sine.mat'
        # save_path = 'closed_loop/sine/closedloop_traj_hybrid_expanded_' + str(policy[N_choice]) + '_sine.mat'
        # save_path = 'closed_loop/sine/closedloop_traj_supervised_expanded_' + str(policy[N_choice]) + '_sine.mat'
        # save_path = 'closed_loop/sine/closedloop_traj_selfsupervised_expanded_' + str(policy[N_choice]) + '_sine.mat'
