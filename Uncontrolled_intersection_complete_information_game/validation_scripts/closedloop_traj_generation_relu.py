...
if __name__ == '__main__':
    ...
    ckpt_path = './model/relu/model_hybrid_' + str(policy[N_choice]) + '_relu.pth'
    # ckpt_path = './model/relu/model_supervised_' + str(policy[N_choice]) + '_relu.pth'
    # ckpt_path = './model/relu/model_selfsupervised_' + str(policy[N_choice]) + '_relu.pth'
    activation = 'relu'
    ...
    if save_data:
        save_path = 'closed_loop/relu/closedloop_traj_hybrid_initial_' + str(policy[N_choice]) + '_relu.mat'
        # save_path = 'closed_loop/relu/closedloop_traj_supervised_initial_' + str(policy[N_choice]) + '_relu.mat'
        # save_path = 'closed_loop/relu/closedloop_traj_selfsupervised_initial_' + str(policy[N_choice]) + '_relu.mat'
        # save_path = 'closed_loop/relu/closedloop_traj_hybrid_expanded_' + str(policy[N_choice]) + '_relu.mat'
        # save_path = 'closed_loop/relu/closedloop_traj_supervised_expanded_' + str(policy[N_choice]) + '_relu.mat'
        # save_path = 'closed_loop/relu/closedloop_traj_selfsupervised_expanded_' + str(policy[N_choice]) + '_relu.mat'
