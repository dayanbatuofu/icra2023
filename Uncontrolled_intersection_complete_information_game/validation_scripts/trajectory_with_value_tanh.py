...
if bvpNAA is True:
    ...
    # file = 'closed_loop/tanh/closedloop_traj_valuehardening_expanded_na_a_tanh.mat'
    index = 2
    # title = 'GT $\Theta^{*}=(na,a)$'
...
if bvpNANA is True:
    ...
    # file = 'closed_loop/tanh/closedloop_traj_valuehardening_expanded_na_na_tanh.mat'
    index = 2
