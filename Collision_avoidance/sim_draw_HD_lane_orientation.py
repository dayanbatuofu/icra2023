...
class VisUtils:
    ...
    def __init__(self):
        ...
        # load_path = 'examples/vehicle/data_test_a_a_GT.mat'
        # load_path = 'examples/vehicle/data_test_a_a_SSL.mat'
        # load_path = 'examples/vehicle/data_test_a_a_SL.mat'
        # load_path = 'examples/vehicle/data_test_a_a_HL.mat'
        load_path = 'examples/vehicle/data_test_a_a_VH.mat'
    ...
    def generate(self, data):
        ...
        # SL: t_bar = np.linspace(0, 0.9, 7)
        # GT, HL: t_bar = np.linspace(0, 3, 21)
        ...
        X = data['X']
        while time <= 3.0:  # SL: 0.9; GT, HL: 3.0; SSL: 0.9
            while t[0][i] <= time:
                i += 1
            """
...
if __name__ == '__main__':
    ...
    imageio.mimsave(path + 'movie_' + tag + '.gif', images, 'GIF', fps=7)
