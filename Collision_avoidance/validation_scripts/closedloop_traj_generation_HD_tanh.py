...
def value_action(X, t, model):
    ...
    dx_2 = 2.0 * (X[4, :] - 15) / (90 - 15) - 1.
    dy_2 = 2.0 * (X[5, :] - 32) / (38 - 32) - 1.
    theta_2 = 2.0 * (X[6, :] - (-0.15)) / (0.18 - (-0.15)) - 1.
    v_2 = 2.0 * (X[7, :] - 18) / (25 - 18) - 1.
...
if __name__ == '__main__':
    ...
    # ckpt_path = './model/tanh/model_supervised_HD_tanh.pth'
    # ckpt_path = './model/tanh/model_selfsupervised_HD_tanh.pth'
    ...
    if save_data:
        save_path = 'closed_loop/tanh/closedloop_traj_hybrid_HD_tanh.mat'
        # save_path = 'closed_loop/tanh/closedloop_traj_supervised_HD_tanh.mat'
        # save_path = 'closed_loop/tanh/closedloop_traj_selfsupervised_HD_tanh.mat'
        # save_path = 'closed_loop/tanh/closedloop_traj_valuehardening_HD_tanh.mat'
